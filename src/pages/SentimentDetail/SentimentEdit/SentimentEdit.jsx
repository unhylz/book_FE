...
import "../../SentimentWrite/SentimentWrite.scss";
import { PiStarFill, PiStarLight } from "react-icons/pi";
import Modal from "react-modal";
import { Link, useNavigate, useParams } from 'react-router-dom';
import { UserContext } from "../../../context/Login";
import { SentimentBookSearch } from "../../SentimentWrite/api";
import searchIcon from "../../SentimentWrite/search.png"
import axios from "axios";
import "../../SentimentWrite/BookSearch.scss";
...
//====================================== API 연동==================================
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // API 요청
      const response = await axios.patch(`/sentiments/${user_id}/rewrite/${id}`, formData);
