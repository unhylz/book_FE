    ...
    <div className='login_popup'>
      ...
      <form>
        ...
        <div className={`pw_input_${props.notice}`}>
            ...
            <img className='cancle' src={cancle_icon} onClick={props.onPwCancleHandler}/>
        </div>
        <div className='remember'
        onClick={()=>{setIsRemember( isRemember ? false : true)}}>
          <div>{isRemember ? <img src={checkbox_green}/>:<img src={checkbox_black}/>}
          자동로그인</div>
          {props.notice===0 ?
          <></>
          : props.notice=== 1?
        ...
        <input className='submit_input' type='submit' value="로그인" onClick={props.onSubmitHandler}/>
      </form>
