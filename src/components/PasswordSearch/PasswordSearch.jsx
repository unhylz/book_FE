        ...
        <form>
          <div className="input_form">
            <div className="input_line">
              ...
              <div className="send_btn" onClick={props.onClickSendBtn}>
                번호받기
              </div>
            </div>
          ...
          <div className="auth_form">
            <div className="auth_line">
              ...
              <div className="resend" onClick={props.onClickResendBtn}>
                재전송
              </div>
          ...
          <div className="pw_change_btn">
            <button type="button" onClick={props.onSubmitHandler}>
              비밀번호 변경
            </button>
          </div>
        </form>
